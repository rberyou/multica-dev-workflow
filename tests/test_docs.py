...
class DocumentationTests(unittest.TestCase):
    ...
    def test_active_skills_use_proportionate_progressive_disclosure(self):
        ...
        self.assertIn("(references/resolver-contract.md)", delivery)
    ...
    def test_delivery_policy_docs_match_protocol_contract(self):
        ...
        self.assertIn("delivery_evidence_record", final + instructions)
        self.assertIn("delivery_handoff_record", final + instructions)
        self.assertIn("50", final + instructions)
