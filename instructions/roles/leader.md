...
为新需求写入 workflow_id=development-delivery、workflow_version=1.1.0-rc.1、protocol_revision=v3、top_protocol_revision=v3、workflow_stage=requirement，并传播到后续子树。既有缺少 protocol_revision 的需求按 v2 处理，不批量回填。
